...
# Function to calculate NIQE and BRISQUE
def metrics(im_dir):
    avg_niqe = 0
    n = 0
    avg_brisque = 0
...
if __name__ == '__main__':
    ...
    # Define the image directory based on the dataset type
    if ep.DICM:
    ...
    # # Print the results
    # print(f"NIQE: {avg_niqe}")
    # print(f"BRISQUE: {avg_brisque}")

    # Return the results as a string in the format "NIQE BRISQUE"
    print(f"{avg_niqe} {avg_brisque}")
